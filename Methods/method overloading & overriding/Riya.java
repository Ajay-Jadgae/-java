class Riya{
	...
	public void displayDetails(){
		...
		System.out.println("This is no argumental method in super class.");
		
	}
	public void displayDetails(int id){
		
		System.out.println("This is one argumental method in super class.");
		System.out.println("Id = "+id);
		
	}
	public void displayDetails(int id,String name){
		
		System.out.println("This is two argumental method in super class.");
		System.out.println("Id = "+id);
	...
	public void displayDetails(int id,String name,long phoneNumber){
		...
		System.out.println("This is three argumental method in super class.");
		System.out.println("Id = "+id);
		System.out.println("Name = "+name);
	...
	public void displayDetails(int id,String name,long phoneNumber,double result){
		...
		System.out.println("This is four argumental method in super class.");
		System.out.println("Id = "+id);
		System.out.println("Name = "+name);
		System.out.println("Phone Number = "+phoneNumber);
	...
	public void displayDetails(int id,String name,long phoneNumber,double result,float percentage){
		...
		System.out.println("This is five argumental method in super class.");
		System.out.println("Id = "+id);
		System.out.println("Name = "+name);
		System.out.println("Phone Number = "+phoneNumber);
		System.out.println("Result = "+result);
	...
	public void displayDetails(int id,String name,long phoneNumber,double result,float percentage,char rating){
		...
		System.out.println("This is six argumental method in super class.");
		System.out.println("Id = "+id);
		System.out.println("Name = "+name);
		System.out.println("Phone Number = "+phoneNumber);
		System.out.println("Result = "+result);
	...
	public void displayDetails(int id,String name,long phoneNumber,double result,float percentage,char rating,boolean isPassed){
		...
		System.out.println("This is seven argumental method in super class.");
		System.out.println("Id = "+id);
		System.out.println("Name = "+name);
		System.out.println("Phone Number = "+phoneNumber);
		System.out.println("Result = "+result);
