class Abhi extends Person{
	...
	public Abhi(){
		...
		super();
		System.out.println("This is no argumental constructor in Abhi class.");
		
	}
	public Abhi(int idNumber,String personName,long phoneNumber,double percentageHSC,float percentageSSC,char rating,boolean isGraduate){
