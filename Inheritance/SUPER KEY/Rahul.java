class Rahul extends DoctorTom{
	...
	public Rahul(){
		...
		super();
		System.out.println("This is no argumental constructor in Rahul class.");
		
	}
	public Rahul(int salary,String doctorName,long phoneNumber,double curedPercentage,float tax,char rating,boolean isCured){
